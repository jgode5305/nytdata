...
If you wrote the above code correctly, you should be able to run the code below and [match the results from AP](https://www.google.com/search?q=final+results+new+hampshire&rlz=1C5CHFA_enUS865US865&oq=fianl+results+new+hampshire&aqs=chrome..69i57j33l7.3442j0j7&sourceid=chrome&ie=UTF-8).
